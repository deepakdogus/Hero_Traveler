...
class FormInput extends Component {
  ...
  static propTypes = {
    ...
    placeholderColor: PropTypes.object,
  ...
  renderText = () => {
    const {onPress, value, placeholder, placeholderColor, keyboardType, cost, onChangeText} = this.props
    if (onPress) {
      return (
        <Text
          style={[detailsStyles.inputStyle, value ? null : { color: placeholderColor ? placeholderColor : Colors.navBarText }]}
          numberOfLines={1}
          ellipsizeMode={'tail'}
        >
          {value || placeholder}
    ...
    return (
      <Fragment>
        ...
        <TextInput
          ...
          placeholderTextColor={ placeholderColor ? placeholderColor : Colors.navBarText }
          value={value}
