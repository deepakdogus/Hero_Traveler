...
const TermsAndConditions = () => (
  <Wrapper>
    ...
    <Container>
      ...
      <OLBody>
        Subject to your compliance with the terms and conditions set out in these Terms, Hero Traveler hereby grants you a personal, limited, non-exclusive, non-transferable, freely revocable license to use the Hero Traveler Service for the non-commercial viewing of content (as defined below).
      </OLBody>
      <Header>
        3. Produced Content
      </Header>
      ...
      <BodyNumber>7.1</BodyNumber>
      <Body>
        If you become a registered member and create an account on the Hero Traveler Service, you agree to be responsible and/or liable for: maintaining the confidentiality of passwords or other account identifiers which you choose; and all activities that occur under such password or account identifiers.
      </Body>
      <BodyNumber>7.2</BodyNumber>
      <Body>
        You agree to notify Hero Traveler of: any loss of your password or account identifiers; and any unauthorized use of your password or account identifiers.
      </Body>
      <BodyNumber>7.3</BodyNumber>
      <Body>
        Without limiting anything in this Agreement, Hero Traveler will not be responsible or liable, directly or indirectly, in any way for any loss or damage of any kind incurred as a result of, or in connection with, your failure to comply with this Section 7.
      </Body>
      <BodyNumber>7.4</BodyNumber>
      <Body>
        You may not browse the Site and view Content without registering, you are required to register and select a password and screen name (“User ID”). You shall provide Hero Traveler with accurate, complete, and updated registration information. Failure to do so shall constitute a breach of the Terms of Use, which may result in immediate termination of your account. You shall not (i) select or use as a User ID or domain a name of another person with the intent to impersonate that person; (ii) use as a User ID or domain a name subject to any rights of a person other than you without appropriate authorization; or (iii) use as a User ID or domain a name that is otherwise offensive, vulgar or obscene. Hero Traveler reserves the right to refuse registration of, or cancel a User ID and domain in its sole discretion. You are solely responsible for activity that occurs on your account and shall be responsible for maintaining the confidentiality of your password. You shall never use another user’s account without such other user’s express permission. You will immediately notify Hero Traveler in writing of any unauthorized use of your account, or other account related security breach of which you are aware.
      </Body>
      <Header>
        Governing Law & Venue
      </Header>
